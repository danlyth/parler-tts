...
def get_args():
    ...
    parser.add_argument("--json_path", type=str, required=True, help="Path to the json file containing the arguments")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="I guess if you've truly hit rock bottom, the only place is up, right?",
        help="Test sentence to generate audio for",
    )
    return parser.parse_args()


def main(json_path: str, audio_ref_embedding_path: str, output_audio_path: str, test_sentence: str):
